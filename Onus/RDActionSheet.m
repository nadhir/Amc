...
const CGFloat kActionSheetAnimationTime = 0.4;
...
- (void)buttonWasPressed:(id)button {
    [[NSNotificationCenter defaultCenter] postNotificationName:@"hideMenu2" object:nil];
...
- (void)showFrom:(UIView *)view {
    ...
    CGFloat startPosition = view.bounds.origin.y + view.bounds.size.height-45;
