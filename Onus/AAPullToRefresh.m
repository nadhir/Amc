...
- (void)_commonInit
{
  ...
  //  [self addSubview:_activityIndicatorView];
    ...
    //-------- Title-----------------------
    _fromLabel = [[UILabel alloc]initWithFrame:CGRectMake(-100, 5, 200, 30)];
    _fromLabel.numberOfLines = 1;
   // fromLabel.baselineAdjustment = UIBaselineAdjustmentAlignBaselines;
    //fromLabel.adjustsFontSizeToFitWidth = YES;
    //fromLabel.adjustsLetterSpacingToFitWidth = YES;
    _fromLabel.font=[UIFont fontWithName:@"Helvetica" size:12];
   // fromLabel.minimumScaleFactor = 18.0f/20.0f;
...
- (void)setupScrollViewContentInsetForLoadingIndicator:(actionHandler)handler
{
    ...
    if (self.position == AAPullToRefreshPositionTop) {
        ...
        currentInsets.top = MIN(offset, self.originalInsetTop + self.bounds.size.height + 40.0f);
    } else {
             ...
             //            [self.activityIndicatorView stopAnimating];
              ...
              //               self.activityIndicatorView.transform = CGAffineTransformIdentity;
                             ...
                             self.state = AAPullToRefreshStateNormal;
                               ...
                               [self.scrollView setContentOffset:CGPointMake(self.scrollView.contentInset.left, -40) animated:YES];
                         }];
                     }];
}
